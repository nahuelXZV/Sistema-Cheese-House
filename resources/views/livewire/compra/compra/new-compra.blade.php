<div>
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <div class="mb-6">
            ...
            <input type="text" wire:model.lazy="compraArray.monto_total""
        ...
        <div class="mb-6">
            ...
            <input type="date" wire:model.lazy="compraArray.fecha"" value="{{ date('Y-m-d') }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="0.00" readonly>
        ...
        <div class="mb-6">
            ...
            <input type="time" wire:model.lazy="compraArray.hora"" value="{{ date('H:i') }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="0.00" readonly>
        ...
        <div class="mb-6">
            ...
            <select wire:model="compraArray.tipo_pago" required
                class="w-full px-2 py-2 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="mb-6 col-span-2">
            ...
            <textarea id="message" rows="4" wire:model.lazy="compraArray.descripcion"
