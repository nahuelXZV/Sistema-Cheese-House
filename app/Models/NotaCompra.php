...
class NotaCompra extends Model
{
    ...
    static public function GetNotaCompras($attribute, $order, $paginate)
    {
        $notaCompras = NotaCompra::join('proveedors', 'nota_compras.proveedor_id', '=', 'proveedors.id')
            ...
            ->orWhere('proveedors.nombre_empresa', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('users.name', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('nota_compras.fecha', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('nota_compras.hora', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('nota_compras.monto_total', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('nota_compras.estado', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('nota_compras.descripcion', 'ILIKE', '%' . strtolower($attribute) . '%')
            ->orWhere('nota_compras.tipo_pago', 'ILIKE', '%' . strtolower($attribute) . '%')
